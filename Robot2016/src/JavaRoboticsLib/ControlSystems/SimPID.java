...
/**
 * This class was imported from Simbotics code. The original class calculates the PID values
 * based on an error computed externally. We have changed it to have the error computed when
 * the PID is called (calcPID(value)) with an actual value coming from the feedback of the system
 * being controlled. A setpoint is a variable in this class, and it is used to compute the error
 * as (value-setpoint).
 * 
